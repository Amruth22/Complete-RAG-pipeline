...
def main():
    ...
    if not rag.load_existing_index():
        ...
        # Ingest the document
        ingestion_stats = rag.ingest_documents([sample_story])
    ...
    demo_questions = [
        "Who is Lyra Moonwhisper?",
        "What are the five Sacred Temples?",
        "What is the Void Blight?",
        "How did Lyra become a Guardian?",
